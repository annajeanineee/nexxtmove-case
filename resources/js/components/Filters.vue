                                ...
                                <PopoverPanel class="absolute right-0 z-10 mt-2 origin-top-right rounded-md bg-white p-4 shadow-2xl ring-1 ring-black/5 focus:outline-hidden">
                                    <div class="space-y-2">
                                        <label class="flex items-center gap-2 text-sm">
                                            <input type="radio" class="size-4" value="" v-model="filters.status" @change="onFilterChange()" />
                                            <span>Alle</span>
                                        </label>
                                        <label class="flex items-center gap-2 text-sm">
                                            <input type="radio" class="size-4" value="available" v-model="filters.status" @change="onFilterChange()" />
